...
4. You'll need to install some R packages in RStudio that we will use throughout the semester. To do so, open RStudio then copy-paste [this code](../content/packages.R) into the console and press Return. This will install all the packages listed in the file.
