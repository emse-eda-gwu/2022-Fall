...
On Blackboard under the assignment titled "Team Member Review: Final Report", review each of your team members' contributions to the project. For each member, do the following:

- Write a short description of the specific contributions the team member made throughout the whole project (from proposal to the final report).
- Provide an honest breakdown of how the team member contributed to the project (totaling to 100%).
